...
class TestYoutube < TestSite
    ...
    def testJsonToItem()
        ...
        expected_si.title = "PSY - GANGNAM STYLE"
        expected_si.url = "https://www.youtube.com/watch?v=9bZkp7q19f0"
        expected_si.date = 1342338392
        expected_si.thumb = "https://i.ytimg.com/vi/9bZkp7q19f0/mqdefault.jpg"
        expected_si.identifier = "9bZkp7q19f0"
